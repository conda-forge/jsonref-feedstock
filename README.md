About jsonref-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsonref-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3029&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsonref-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsonref` can be installed with `conda`:
...
```
mamba install jsonref
```

It is possible to list all of the versions of `jsonref` available on your platform with `conda`:
...
```
mamba search jsonref --channel conda-forge
```
...
mamba repoquery search jsonref --channel conda-forge

# List packages depending on `jsonref`:
mamba repoquery whoneeds jsonref --channel conda-forge

# List dependencies of `jsonref`:
mamba repoquery depends jsonref --channel conda-forge
```
